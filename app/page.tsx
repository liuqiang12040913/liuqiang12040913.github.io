        ...
        <Card className="p-5 md:p-6">
          <div className="space-y-4 text-lg text-slate-700 leading-relaxed">
            ...
            <p>
              ...
              My research philosophy is to integrate rigorous theoretical analysis with systematic experimentation in real-world systems, with theoretical insights guiding system design and experimental feedback refining algorithms.              
