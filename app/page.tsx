        ...
        <Card className="p-5 md:p-6">
          <div className="space-y-4 text-lg text-slate-700 leading-relaxed">
            ...
            <p>
              ...
              I have received the NSF CAREER Award (2026), Best Paper Award at IEEE ICC (2019 and 2022), Best Paper Award at IEEE TAOS (2019), NVIDIA Academic Grant Award(2025), Edgerton Innovation Award (2025), and Research Excellence Award (2024).
            ...
            <p className="font-medium text-red-800">
              For students in CSCE 464/864, send me an email if you are making up the quizzes directly, since Canvas is unavailable now.
            </p>
          </div>
        </Card>
      </Section>
