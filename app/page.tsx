        ...
        <div className="mx-auto max-w-6xl grid md:grid-cols-2 gap-8 items-start">
          ...
          <div className="hidden md:flex justify-center">
            <img
              ...
              alt={`Dr. ${site.name}`}
              className="rounded-xl shadow-soft w-full max-w-[200px] md:max-w-[260px] object-cover"
            />
          </div>
        </div>
      </Section>
        ...
        <Card className="p-5 md:p-6">
          <div className="space-y-4 text-lg text-slate-700 leading-relaxed">
            ...
            <p>
              ...
              I am the principal investigator of <a href='https://husker-net.unl.edu/' target="_blank" rel="noopener noreferrer" className='text-blue-700 hover:text-blue-800'>Husker-Net</a>, the first multi-campus private 5G network at the University of Nebraska-Lincoln, supported by the NSF Campus Cyberinfrastructure (CC*) program.
            </p>
